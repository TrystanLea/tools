...
<div class="container" style="max-width:1200px" id="app">
    <div class="row">
        <div class="col">
            <br>
            <h3>Volume simulator with heat pump COP</h3>
            <p>Explore heat pump minimum modulation and cycling's effect of COP.</p>
...
<script src="<?php echo $path; ?>volume_sim_cop.js?v=16"></script>
