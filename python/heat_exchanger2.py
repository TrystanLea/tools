...
for i in range(0,100):
  Thi = Tho + heatpump_output/(Cph*mh)
  ...
  if round(heat_output*100)==round(last_heat_output*100) and round(Q*100)==round(heat_output*100):
    break

COP = heatpump_COP(Thi,T_ambient)

print ("---------------")
print ("HP COP %0.2f" % COP)
print ("Thi: %0.1f" % Thi)
print ("Tho: %0.1f" % Tho)
print ("Tco: %0.1f" % Tco)
print ("Tci: %0.1f" % Tci)
print ("H %dW" % round(heat_output))

COP = heatpump_COP(Tco,T_ambient)

print ("---------------")
print ("HP COP %0.2f @ Tco %0.1f" % (COP,Tco))
